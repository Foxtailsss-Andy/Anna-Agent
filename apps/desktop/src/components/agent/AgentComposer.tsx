...
export interface AgentComposerProps {
  ...
  /** C2(校对基准 P-02):档位 mono pill,如 "default · deepseek-chat";真档案数据 */
  modelLabel?: string;
  onModelClick?: () => void;
  /** 底部说明行,如 "Enter 发送 · Shift+Enter 换行 · 内容由 AI 生成,请注意甄别" */
  footnote?: string;
}
  ...
  const handleKeyDown = useCallback(
    (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
      ...
      handleComposerEnter(
        ...
        { running, hasText: value.trim().length > 0, onSend },
      );
    },
    ...
    <div className="acp">
      <div className="acp__card">
        ...
        <div className="acp__bar">
          ...
          {/* 模型档位 pill(C2,校对基准 P-02:mono 真档案名,如 "default · deepseek-chat") */}
          {props.modelLabel && (
            <button
              type="button"
              className="acp__model"
