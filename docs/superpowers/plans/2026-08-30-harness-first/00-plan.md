...
- HF-02: S0 identity/admission and [S1 actual managed worker](HF-02-S1-managed-worker.md) are published with green exact-SHA CI at `c030246`; see the [S1 handoff](../../handoff/2026-08-30-hf-02-s1-runtime-materialization.md). [S2 canonical restore](HF-02-S2-canonical-restore.md) has passed final fixed-source dual review and local gates; exact-SHA publication is tracked in PR 1. Rejected checkpoints, corrected test barriers and final evidence are retained in the [S2 handoff](../../handoff/2026-08-31-hf-02-s2-canonical-restore.md). [S3 scoped controls](HF-02-S3-scoped-controls.md) is separately design-frozen, with no source implementation yet. Steer/answer, full isolation, distribution and parent-ticket acceptance remain open.
